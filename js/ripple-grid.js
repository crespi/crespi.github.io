...
(function() {
    ...
    const fsSource = `
        ...
        const float WOBBLE_AMOUNT = 100.0; // how much the shape varies (pixels)
        ...
        void main() {
            ...
            // Which letter of "hello" based on cell X position (tiled)
            float letterIndex = mod(cell.x, WORD_LENGTH);

            // Sample texture - texture is "hello" (5 chars, 80px wide)
